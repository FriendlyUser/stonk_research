...
\begin{figure}
\begin{tikzpicture}
    \begin{axis}[domain=50:150]
    \addplot[mark=none, samples=100, red, xlabel={Netback per barrel of oil},
    ylabel={Million of dollars \$ (CAD)}] function {0.66*x};
    \end{axis}
\end{tikzpicture}
\caption{Netback vs price of oil}
\end{figure}
